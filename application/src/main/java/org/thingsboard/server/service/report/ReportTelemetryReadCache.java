...
public class ReportTelemetryReadCache {
         ...
         */
        private final ThreadLocal<Deque<ScopeState>> scopes = ThreadLocal.withInitial(ArrayDeque::new);
        ...
        public List<ReportMetricPoint> getOrLoad(
                ...
                List<ReportMetricPoint> cached = state.entries.get(queryKey);
                ...
                List<ReportMetricPoint> loaded = immutablePoints(
                                loader.get());
        ...
        private void closeScope(
                ...
                ScopeState currentState = stack.peek();
        ...
        private List<ReportMetricPoint> immutablePoints(
                ...
                List<ReportMetricPoint> copied = copyPoints(points);
        ...
        private static final class ScopeState {
                ...
                private final Map<QueryKey, List<ReportMetricPoint>> entries = new HashMap<>();
