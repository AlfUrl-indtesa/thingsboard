...
public class DefaultReportTelemetryService implements ReportTelemetryService {

    private final TbTelemetryReader tbTelemetryReader;
    private final ReportEntityIdFactory reportEntityIdFactory;

    @Override
    public ReportTimeSeries findSeries(TenantId tenantId,
        ...
        series.setKey(query.getKey());
        series.setLabel(query.getLabel() != null ? query.getLabel() : query.getKey());
        series.setUnit(query.getUnit());
        series.setAggregation(query.getAggregation());
        series.setStartTs(query.getStartTs());
        series.setEndTs(query.getEndTs());
        series.setPoints(
