...
public class ReportExecutionController
    ...
    private final ReportExecutionService
            reportExecutionService;

    private final ReportStorageService
    ...
    @GetMapping(
            "/report-executions/template/{templateId}"
    )
    @ResponseBody
    public Page<ReportExecution>
    getReportExecutionsByTemplateId(
    ...
    @GetMapping(
            "/report-executions/{executionId}/download"
    )
    ...
    downloadReportExecution(
        ...
        ReportExecution execution =
                reportExecutionService.findById(
                        tenantId,
                        executionId
                );

        Resource resource =
                reportStorageService.loadFile(
                        tenantId,
                        execution
                );

        String fileName =
                execution.getFileName() != null
